...
@section('title')Категория {{$category}}@endsection
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>
                            ...
                            <input type="hidden" name="_token" value="AkBrUeKV5y0UogMFiWIiou4KHyJOJyBvS6KoVjfu">            </form>
                        <p></p>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>89990 ₽</p>
                        <p>
                        </p><form action="http://internet-shop.tmweb.ru/basket/add/2" method="POST">
                            <button type="submit" class="btn btn-primary" role="button">В корзину</button>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>12490 ₽</p>
                        <p>
                        </p><form action="http://internet-shop.tmweb.ru/basket/add/3" method="POST">
                            <button type="submit" class="btn btn-primary" role="button">В корзину</button>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>17221 ₽</p>
                        <p>
                        </p><form action="http://internet-shop.tmweb.ru/basket/add/4" method="POST">
                            <button type="submit" class="btn btn-primary" role="button">В корзину</button>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>11980 ₽</p>
                        <p>
                        </p><form action="http://internet-shop.tmweb.ru/basket/add/12" method="POST">
                            <button type="submit" class="btn btn-primary" role="button">В корзину</button>
